...
# test(summation_using_accumulate, globals())
# =============================================================================
...
# two = successor(one) = lambda f: lambda x: f(f(x))
...
#     int_res = int_m + int_n
#     return int_to_church(int_res)
# =============================================================================

test(add_church, globals(), verbose=True)
...
test(mul_church, globals(), verbose=True)
...
test(pow_church, globals(), verbose=True)