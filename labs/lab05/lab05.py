...
def nut_finder(t):
    ...
    if is_leaf(t):
        ...
        return any([nut_finder(branch) or label(branch) == "nut" for branch in branches(t)])
...
from itertools import zip_longest as outzip        
...
def add_trees(t1, t2):
    ...
    if is_leaf(t1):
        ...
        return tree(label(t1)+label(t2), 
                    [add_trees(b1, b2) for b1, b2 in outzip(branches(t1), branches(t2), fillvalue=tree(0))])
