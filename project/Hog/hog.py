...
# print(take_turn(num_rolls, opponent_score, dice))
# =============================================================================
...
def is_swap(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4
    check = str(3 ** (player_score + opponent_score))
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            score0 += score
            if feral_hogs and abs(num_rolls - last0) == 2:
                score0 += 3
            last0 = score
        else:
            ...
            score1 += score
            if feral_hogs and abs(num_rolls - last1) == 2:
                score1 += 3
            last1 = score
...
def announce_highest(who, prev_high=0, prev_score=0):
    ...
    def say(score0, score1):
        ...
        score = prev_score
        if who:
            gain, score = score1 - score, score1
        else:
            gain, score = score0 - score, score0
        if gain > high:
            high = gain
            print(str(high), "point(s)! That's the biggest gain yet for Player", str(who))       
        return announce_highest(who, prev_high=high, prev_score=score)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    num = 0
    for i in range(1, 11):
        try_roll = make_averaged(roll_dice, num_samples)
        ave = try_roll(i, dice)
        if ave > high_ave:
            num = i
            high_ave = ave
...
# =============================================================================
# print(bacon_strategy(20, 1, margin=1, num_rolls=4))
# =============================================================================
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=6):
    ...
    if is_swap(new_score, opponent_score) and new_score < opponent_score:
        return 0
    elif not is_swap(new_score, opponent_score) and gain >= margin:
        return 0
    return num_rolls
    # END PROBLEM 11

# =============================================================================
# print(swap_strategy(13, 18, 1, 6))
# =============================================================================
